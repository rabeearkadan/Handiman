...
!function (t, e) {
    ...
    var m = "carousell", p = ".bs.carousell", _ = e.fn[m],
        v = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, b = {
            ...
            function t(t, e) {
                this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(e), this._element = t, this._indicatorsElement = this._element.querySelector(".carousell-indicators"), this._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent || window.MSPointerEvent), this._addEventListeners()
            }
            ...
            return n.next = function () {
                ...
                t || (this._isPaused = !0), this._element.querySelector(".carousell-item-next, .carousell-item-prev") && (c.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, n.cycle = function (t) {
                t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
            }, n.to = function (t) {
                var n = this;
                this._activeElement = this._element.querySelector(".active.carousell-item");
                var i = this._getItemIndex(this._activeElement);
                if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) e(this._element).one("slid.bs.carousell", (function () {
                    return n.to(t)
                })); else {
                ...
                e(this._element).off(p), e.removeData(this._element, "bs.carousell"), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                var t = this;
                this._config.keyboard && e(this._element).on("keydown.bs.carousell", (function (e) {
                    return t._keydown(e)
                })), "hover" === this._config.pause && e(this._element).on("mouseenter.bs.carousell", (function (e) {
                    return t.pause(e)
                })).on("mouseleave.bs.carousell", (function (e) {
                    return t.cycle(e)
                ...
                if (this._touchSupported) {
                    ...
                    e(this._element.querySelectorAll(".carousell-item img")).on("dragstart.bs.carousell", (function (t) {
                        return t.preventDefault()
                    })), this._pointerEvent ? (e(this._element).on("pointerdown.bs.carousell", (function (t) {
                        return n(t)
                    })), e(this._element).on("pointerup.bs.carousell", (function (t) {
                        return i(t)
                    })), this._element.classList.add("pointer-event")) : (e(this._element).on("touchstart.bs.carousell", (function (t) {
                        return n(t)
                    })), e(this._element).on("touchmove.bs.carousell", (function (e) {
                        return function (e) {
                            e.originalEvent.touches && e.originalEvent.touches.length > 1 ? t.touchDeltaX = 0 : t.touchDeltaX = e.originalEvent.touches[0].clientX - t.touchStartX
                        }(e)
                    })), e(this._element).on("touchend.bs.carousell", (function (t) {
                        return i(t)
                    })))
                }
                ...
                return this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(".carousell-item")) : [], this._items.indexOf(t)
                ...
                var i = this._getItemIndex(t), o = this._getItemIndex(this._element.querySelector(".active.carousell-item")),
                    s = e.Event("slide.bs.carousell", {relatedTarget: t, direction: n, from: o, to: i});
                ...
                var i, o, s, r = this, a = this._element.querySelector(".active.carousell-item"), l = this._getItemIndex(a),
                    h = n || a && this._getItemByDirection(t, a), u = this._getItemIndex(h), d = Boolean(this._interval);
                if ("next" === t ? (i = "carousell-item-left", o = "carousell-item-next", s = "left") : (i = "carousell-item-right", o = "carousell-item-prev", s = "right"), h && e(h).hasClass("active")) this._isSliding = !1; else if (!this._triggerSlideEvent(h, s).isDefaultPrevented() && a && h) {
                    this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(h);
                    var f = e.Event("slid.bs.carousell", {relatedTarget: h, direction: s, from: l, to: u});
                ...
                return this.each((function () {
                    var i = e(this).data("bs.carousell"), o = a(a({}, v), e(this).data());
                    "object" == typeof n && (o = a(a({}, o), n));
                    var s = "string" == typeof n ? n : o.slide;
                    if (i || (i = new t(this, o), e(this).data("bs.carousell", i)), "number" == typeof n) i.to(n); else if ("string" == typeof s) {
                ...
                if (i) {
                    var o = e(i)[0];
                    if (o && e(o).hasClass("carousell")) {
                        var s = a(a({}, e(o).data()), e(this).data()), r = this.getAttribute("data-slide-to");
                        r && (s.interval = !1), t._jQueryInterface.call(e(o), s), r && e(o).data("bs.carousell").to(r), n.preventDefault()
                    }
                }
            }, o(t, null, [{
                key: "VERSION", get: function () {
    ...
    e(document).on("click.bs.carousell.data-api", "[data-slide], [data-slide-to]", E._dataApiClickHandler), e(window).on("load.bs.carousell.data-api", (function () {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousell"]')), n = 0, i = t.length; n < i; n++) {
            var o = e(t[n]);
    ...
    }, t.Alert = d, t.Button = g, t.Collapse = D, t.Dropdown = j, t.Modal = R, t.Popover = it, t.Scrollspy = lt, t.Tab = ht, t.Toast = gt, t.Tooltip = $, t.Util = c, Object.defineProperty(t, "__esModule", {value: !0})
}));
