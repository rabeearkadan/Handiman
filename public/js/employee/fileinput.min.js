...
!function (e) {
    ...
    var i = function (e) {
            ...
            data: {}, init: function (e) {
                ...
                var r, l, o = "init_" + t, s = a.data[i], d = s.config[t], c = s.initId + "-" + o,
                ...
                var r = n.config[i], l = W("caption", r) ? r.caption : "", o = W("width", r) ? r.width : "auto",
                    s = W("url", r) ? r.url : !1, d = W("key", r) ? r.key : null, c = s === !1 && t,
                    p = n.isDelete ? n.actions(!1, !0, c, s, d) : "", u = n.footer.replace(/\{actions\}/g, p);
        ...
        k = '<button type="button" class="kv-file-upload {uploadClass}" style="display:none;" title="{uploadTitle}">   {uploadIcon}\n</button>\n',
        ...
        R = {
            ...
            btnLink: b,
            btnBrowse: C
        }, z = {generic: I, html: S, image: P, text: D, video: U, audio: j, flash: A, object: L, other: O},
    ...
    J.prototype = {
        constructor: J, validate: function () {
            ...
            var n = this, r = e.trim(t + ""), l = "." === r.slice(-1) ? "" : ".",
            ...
            var i = this, a = i.$element, n = i.$captionContainer, r = i.$btnFile, l = a.closest("form"),
                o = i.$container;
            ...
            var i = this, t = i.minFileCount > 1 ? i.filePlural : i.fileSingle,
                a = i.msgFilesTooLess.replace("{n}", i.minFileCount).replace("{files}", t), n = i.$errorContainer;
            ...
            var i = this, a = i.$container.find(".file-drop-zone"),
            ...
            var r = this, l = a === !1 ? "" : ' data-url="' + a + '"', o = n === !1 ? "" : ' data-key="' + n + '"',
                ...
                p = r.otherActionButtons.replace(/\{dataKey\}/g, o), u = r.fileActionSettings,
            ...
            var t = this, a = "indicator" + i, n = a + "Title", r = "file-preview-" + i.toLowerCase(),
            ...
            var r, l, o, d, c, p, u, f, v, g = this, m = g.getFileStack().length, h = new FormData,
                w = g.previewInitId + "-" + i, b = e("#" + w + ":not(.file-preview-initial)"),
                C = b.find(".kv-file-upload"), x = b.find(".kv-file-remove"),
                y = g.filestack.length > 0 || !e.isEmptyObject(g.uploadExtraData), T = {id: w, index: i};
            ...
            var i, t, a, n, r, l = this, o = l.filestack, d = o.length, c = {},
            ...
            l.formdata = new FormData, 0 !== d && p && !l.abort(c) && (i = function () {
                ...
                Z(t) || Z(t.error) ? (l.raise("filebatchuploadsuccess", [r]), i(), l.showPreview ? (o.each(function () {
                    ...
                    return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === s.length ? void l.setThumbStatus(i, "Error") : (-1 !== e.inArray(d, s) ? l.setThumbStatus(i, "Error") : (i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), l.filestack[d] = void 0), void d++)
            ...
            if (this.showPreview) {
                var n = this, r = X.createObjectURL(i), l = "", o = i ? i.name : "",
                    s = n.previewSettings.other || B.other, d = n.renderFileFooter(i.name, s.width),
                    c = t.slice(t.lastIndexOf("-") + 1), p = n.parseFilePreviewIcon(n.getPreviewTemplate("other"), o);
            ...
            if (this.showPreview) {
                var r, l, o, s = this, d = s.parseFileType(i), c = i ? i.name : "", p = s.slug(c),
                    u = s.allowedPreviewTypes, f = s.allowedPreviewMimeTypes, v = s.getPreviewTemplate(d),
                    g = u && u.indexOf(d) >= 0, m = W(d, s.previewSettings) ? s.previewSettings[d] : B[d],
            ...
            function t(e) {
                ...
                var m, h, w, b, C, x, y = v + e, T = p + "-" + y, F = i[e], E = a.slug(F.name), k = (F.size || 0) / 1e3,
                    $ = "", I = X.createObjectURL(F), S = 0, P = a.allowedFileTypes, D = Z(P) ? "" : P.join(", "),
            ...
            var a = this, n = a.$element, r = a.$preview, l = a.reader, o = a.$previewContainer, s = a.$previewStatus,
                ...
                v = a.filestack.length, g = function (t, n, r, l) {
            ...
            var i = this, t = i.$element, n = i.getFileStack(), r = t.val() || n.length && n[0].name || "",
                l = i.slug(r), o = i.isUploadable ? n.length : e, s = a.count(i.id) + o,
            ...
            var r, l, o, s, d, c, p = arguments.length > 1, u = p ? i.originalEvent.dataTransfer.files : n.get(0).files,
                f = Z(n.attr("multiple")), v = 0, g = 0, m = t.filestack.length, h = t.isUploadable, w = f && m > 0,
                b = function (i, a, n, r) {
                    var l = e.extend(t.getOutData({}, {}, u), {id: n, index: r}),
                        o = {id: n, index: r, file: a, files: u};
            ...
            var i = this, t = i.getLayoutTemplate("btnDefault"), a = i[e + "Class"], n = i[e + "Title"],
                r = i[e + "Icon"], l = i[e + "Label"], o = i.isDisabled ? " disabled" : "", s = "button";
            switch (e) {
                case"remove":
