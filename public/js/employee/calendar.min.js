...
Calendar.prototype = {
    constructor: Calendar, back: function (e) {
        var t = this.date,
    ...
    for (var i = [], a = ["year", "month", "labels", "days"], d = 0; d < a.length; d++) {
        var o, l;
        if (i[d] = document.createElement("DIV"), i[d].className = "cjslib-" + a[d], "days" != a[d]) if ("month" != a[d]) {
    ...
    constructor: Organizer, back: function (e) {
        ...
        if ("day" == e) {
            if (1 != t.getDate()) this.changeDateTo(t.getDate() - 1), this.update(); else this.calendar.back("month"), this.changeDateTo(n), (i = this).onMonthChange(function () {
                i.indicateEvents()
            });
        ...
        if ("day" == e) {
            if (t.getDate() != n) t.setDate(t.getDate() + 1), this.update(); else this.calendar.next("month"), t.setDate(1), (i = this).onMonthChange(function () {
                i.indicateEvents()
            });
            document.getElementById(this.calendar.id + "-day-radio-" + (this.calendar.initday + t.getDate())).checked = !0
        } else {
        ...
        this.clearHistory();
        var n = this.calendar.changeDateTo(e, t), i = this;
        setTimeout(function () {
    ...
    for (var t = document.createElement("UL"), n = 0; n < e.length; n++) {
        ...
        var a = document.createElement("DIV"), d = document.createElement("SPAN");
        ...
        if (null == e[n].link || "" == e[n].link) o.appendChild(l); else {
    ...
    e = e || this.data;
    var t = this.calendar.date, n = "", i = "";
    try {
        var a = this.calendar.history.indexOf(this.calendar.getDateString());
        -1 < a && (this.calendar.history.splice(a, 1), document.getElementById(this.id + "-history").children[a].remove()), i += i + document.getElementById(this.id + "-list").innerHTML, n = this.list(e[t.getFullYear()][t.getMonth() + 1][t.getDate()])
    } catch (e) {
    ...
    e = e || this.data;
    var t = this.calendar.date, n = this.remember(t, document.getElementById(this.id + "-list").innerHTML),
    ...
    var i = this.calendar.id, a = this.id;
    t = t || function () {
    }, n = n || function () {
    };
    var d = this;
